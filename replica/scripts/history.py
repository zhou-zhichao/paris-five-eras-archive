...
ZONES = [
    ...
    ("roman_left", [(-850, 250), (-900, -450), (-700, -950), (-150, -1050), (300, -850),
                    (400, -450), (350, -150), (0, 20), (-450, 200)], 60, 330, "roman"),
    ("roman_right", [(100, 250), (450, 220), (480, 520), (150, 550)], 200, 340, "roman"),
    ("frank_cite", None, 480, 700, "medieval"),
    ("frank_right", [(-100, 250), (500, 180), (560, 550), (100, 620), (-200, 500)], 720, 1000, "medieval"),
    ("frank_left", [(-700, 300), (-1000, 50), (-900, -300), (-500, -500), (-100, -520), (250, -380), (300, 0)], 760, 1020, "medieval"),
    ("pa_right", [(-1150, 300), (-1150, 950), (-800, 1200), (-300, 1380), (150, 1430), (550, 1440),
                  (950, 1150), (1080, 650), (1000, -120), (400, 0)], 1080, 1280, "medieval"),
    ("pa_left", [(-950, 600), (-1100, -100), (-950, -650), (-500, -950), (50, -980), (500, -720),
                 (600, -250), (550, 0), (0, 120), (-500, 380)], 1120, 1300, "medieval"),
    ("charles_v", [(-1650, 650), (-1750, 1250), (-1050, 1650), (-300, 1880), (500, 1930), (1050, 1680),
                   (1550, 900), (1650, 100), (1250, -320), (0, -100)], 1280, 1460, "medieval"),
