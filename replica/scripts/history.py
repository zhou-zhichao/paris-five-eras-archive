...
ZONES = [
    ...
    ("roman_left", [(-1250, 350), (-1350, -700), (-1050, -1300), (-100, -1400), (550, -1150),
                    (750, -600), (650, -200), (0, 20), (-600, 250)], -45, 160, "roman"),
    ("roman_right", [(80, 250), (650, 200), (700, 650), (150, 700)], 120, 260, "roman"),
    ...
    ("pa_right", [(-1150, 300), (-1150, 950), (-800, 1200), (-300, 1380), (150, 1430), (550, 1440),
                  (950, 1150), (1080, 650), (1000, -120), (400, 0)], 990, 1220, "medieval"),
    ("pa_left", [(-950, 600), (-1100, -100), (-950, -650), (-500, -950), (50, -980), (500, -720),
                 (600, -250), (550, 0), (0, 120), (-500, 380)], 1030, 1240, "medieval"),
    ("charles_v", [(-1650, 650), (-1750, 1250), (-1050, 1650), (-300, 1880), (500, 1930), (1050, 1680),
                   (1550, 900), (1650, 100), (1250, -320), (0, -100)], 1220, 1420, "medieval"),
    ("faubourg_med", [(-1500, -100), (-1600, -900), (-800, -1400), (300, -1500), (900, -1100), (1400, -500),
                      (1900, 200), (1900, 1300), (1200, 2000), (0, 2200), (-1300, 2100), (-2100, 1500), (-2100, 500)],
     1350, 1560, "medieval"),
    ...
    ("fermiers", [(-4021, 2315), (-2995, 2894), (-1677, 3340), (-400, 3480), (740, 3562), (1472, 3451),
                  ...
                  (-1274, -2115), (-2117, -1224), (-3508, -557), (-4300, 300), (-4607, 1002)], 1780, 1875, "haussmann"),
    ("thiers", "PARIS", 1855, 1935, "haussmann"),          # commune boundary minus the two bois
    ("inner_suburb", ("PARIS_BUFFER", 3500), 1880, 1975, "modern"),
    ("outer_suburb", ("PARIS_BUFFER", 12000), 1930, 2025, "suburb"),
]
...
VILLAGES = [
    ...
    ("Versailles town", -16200, -5100, 700, 1670, 1780),
...
LANDMARKS = [
    ...
    ("louvre", -1029, 896, 7, 1546, 9999, "glb:louvre", {"w": 660, "d": 320, "h": 32}),
    ...
    ("versailles", -16820, -5360, 97, 1661, 9999, "versailles", {}),
