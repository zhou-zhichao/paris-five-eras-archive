...
Style: Year,Bahnschrift,{int(150*scale)},&H00FFFFFF,&H000000FF,&H60000000,&H80000000,1,0,0,0,86,100,{int(10*scale)},0,1,0,{int(3*scale)},3,{int(60*scale)},{int(90*scale)},{int(88*scale)},1
...
Style: Pop,Bahnschrift,{int(44*scale)},&H00E6E6E6,&H000000FF,&H60000000,&H80000000,0,0,0,0,86,100,{int(3*scale)},0,1,0,{int(2*scale)},3,{int(60*scale)},{int(100*scale)},{int(28*scale)},1
...
for i, f in enumerate(frames):
    ...
    lines.append(f"Dialogue: 1,{ts(i*dt)},{ts((i+1)*dt)},Pop,,0,0,0,,{timeline.population_label(y)}")
era_spans = []
cur = None
for i, f in enumerate(frames):
    t = (f - 1) / a.fps
