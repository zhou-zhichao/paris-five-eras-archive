...
STOCK = [(0.80, 0.70, 0.50), (0.76, 0.66, 0.47), (0.84, 0.74, 0.55), (0.74, 0.65, 0.47)]     # London yellow stock brick
REDBRICK = [(0.70, 0.40, 0.30), (0.64, 0.36, 0.27), (0.74, 0.44, 0.33), (0.60, 0.34, 0.26)]
SLATE = [(0.47, 0.46, 0.46), (0.42, 0.41, 0.42), (0.51, 0.50, 0.49)]     # warm grey: cool blue-grey roofs turned the wide views into a grey sheet
TILE = [(0.70, 0.38, 0.26), (0.64, 0.34, 0.24), (0.74, 0.42, 0.28)]
PALETTE = {
    ...
    "georgian": (STOCK + [(0.88, 0.84, 0.74)], SLATE + [(0.46, 0.45, 0.45)]),
    "victorian": (STOCK + REDBRICK[:2] + [(0.86, 0.82, 0.72)], SLATE + [(0.62, 0.34, 0.24)]),
    "interwar": ([(0.86, 0.78, 0.64), (0.70, 0.42, 0.30), (0.90, 0.84, 0.72), (0.66, 0.40, 0.29)], TILE + [(0.52, 0.36, 0.28)]),
    "postwar": ([(0.74, 0.58, 0.46), (0.80, 0.78, 0.74), (0.68, 0.52, 0.42), (0.84, 0.82, 0.78)],
                [(0.56, 0.55, 0.54), (0.50, 0.50, 0.50), (0.60, 0.58, 0.56)]),
    "modern": ([(0.80, 0.70, 0.60), (0.70, 0.74, 0.78), (0.86, 0.82, 0.76), (0.64, 0.66, 0.70)],
               [(0.58, 0.58, 0.58), (0.52, 0.54, 0.56), (0.62, 0.60, 0.58)]),
    "estate": ([(0.80, 0.78, 0.74), (0.72, 0.66, 0.58), (0.76, 0.74, 0.70), (0.68, 0.68, 0.66)],
               [(0.54, 0.54, 0.54), (0.48, 0.48, 0.50)]),
