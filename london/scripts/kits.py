...
STOCK = [(0.62, 0.55, 0.40), (0.58, 0.50, 0.36), (0.66, 0.58, 0.42), (0.55, 0.47, 0.34)]
REDBRICK = [(0.55, 0.30, 0.22), (0.50, 0.27, 0.20), (0.60, 0.34, 0.25), (0.46, 0.26, 0.20)]
SLATE = [(0.30, 0.31, 0.35), (0.26, 0.27, 0.31), (0.34, 0.35, 0.38)]
TILE = [(0.62, 0.30, 0.20), (0.56, 0.27, 0.19), (0.66, 0.34, 0.22)]
PALETTE = {
    ...
    "georgian": (STOCK + [(0.84, 0.80, 0.70)], SLATE + [(0.34, 0.33, 0.33)]),
    "victorian": (STOCK + REDBRICK[:2], SLATE),
    "interwar": ([(0.82, 0.74, 0.60), (0.62, 0.36, 0.26), (0.86, 0.80, 0.68), (0.58, 0.34, 0.25)], TILE + [(0.44, 0.30, 0.24)]),
    "postwar": ([(0.66, 0.50, 0.38), (0.72, 0.70, 0.66), (0.60, 0.44, 0.34), (0.76, 0.74, 0.70)],
                [(0.46, 0.45, 0.44), (0.40, 0.40, 0.40), (0.50, 0.48, 0.46)]),
    "modern": ([(0.72, 0.62, 0.52), (0.62, 0.66, 0.70), (0.80, 0.76, 0.70), (0.56, 0.58, 0.62)],
               [(0.50, 0.50, 0.50), (0.44, 0.46, 0.48), (0.54, 0.52, 0.50)]),
    "estate": ([(0.74, 0.72, 0.68), (0.66, 0.60, 0.52), (0.70, 0.68, 0.64), (0.62, 0.62, 0.60)],
               [(0.46, 0.46, 0.46), (0.40, 0.40, 0.42)]),
