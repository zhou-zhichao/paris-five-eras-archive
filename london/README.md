...
Procedural 196-second film of London growing from the pre-Roman Thames marshes to 2025, in the
format of the Paris replica (`../replica/`): an oblique low-poly map, era label bottom-left,
year counter + population bottom-right, 2560x1440 @ 30 fps, 196 s.
...
* **higher-fidelity landmarks**: ~120 three.js models (`assets/model_src/models/*.mjs`, exported to
  `assets/models/*.glb`) at true scale, drawn at true scale in plan and **1.5x in height**; ~290 dated
...
London v30 (`45e156b`): marsh reed beds, continuous Walbrook, corrected lake and dock terrain, and historical corrections.

## Pipeline

Run these commands from `london/`.
